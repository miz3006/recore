...
function DemoSignal({ text, pr }: { text: string; pr: boolean }) {
  ...
  // Record contract: comparisons are archival neutral mono — lime belongs to
  // PLANNED prescriptions only, and this demo shows none.
  return (
    <Animated.Text
      style={[styles.signal, animatedStyle]}
